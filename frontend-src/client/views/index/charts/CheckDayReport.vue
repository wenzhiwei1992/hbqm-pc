...
<script>
    ...
    export default {
        data() {
            return {
                currentDate: [moment(new Date()).format("YYYY-MM-DD"), moment(new Date()).format("YYYY-MM-DD")],
                datas: [],
                table: "",
                buttonData: [
                    {
        ...
        methods: {
            ...
            list() {
                ...
                qualityReportModel.dayReport(model).then(data => {
                    ...
                    html += '<thead>';
                    html += '<tr>';
                    html += '<th colspan="18" style="text-align: center;border :solid 0.1px #696969;">' + '质量报表</th>';
                    html += '</tr>';
                    html += '</thead>';
                    html += '<tbody>';
                    html += '<tr>';
                    ...
                    html += '<td rowspan="1" style="vertical-align:middle;text-align: center;border :solid 0.1px #696969;">修复量（块）</td>';
