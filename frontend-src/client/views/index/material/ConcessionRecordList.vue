            ...
            >
                ...
                >
                        ...
                        <template slot-scope="props">
                            ...
                            >
                                ...
                                <el-table-column
                                        ...
                                        width="140">
                                    <template slot-scope="scope">
                                        <span v-if="scope.row.warehouseStatus!='待审批'"
                                ...
                                <el-table-column
                                        ...
                                        width="80">
                                    <template slot-scope="scope">
                                        <div v-if="scope.row.warehouseStatus=='待审批'">
                    ...
                    <el-table-column
                            ...
                            width="60">
                        <template slot-scope="scope">
                            <el-tooltip v-if="scope.row.status==''" class="item" effect="light" content="一键检验"
                                        placement="top">
                                <el-button type="primary" icon="el-icon-s-promotion"
                                           @click="checkNew(scope.row)"></el-button>
                            </el-tooltip>
                        </template>
                    </el-table-column>
                </el-table>
...
<script>
    ...
    import CheckoutStatus from './ConcessionCheckStatus.vue'
