...
<script>
    ...
    import DeliveryOrderPreviewTL from './DeliveryOrderPreviewTL.vue'
    ...
    export default {
        components: {
            'delivery-order-edit': DeliveryOrderReturn,
            'invoice-print-preview-sj': DeliveryOrderPreviewTL,
        },
        ...
        methods: {
            init(){
                let info = this.$route.params.deliveryOrderId;
                if(info) {
                    this.mode = 'add'
                    this.editForm = {
                        id: '',
                        ...
                        purpose: '生产',
                        deliveryOrderType: '退库',
                        deliveryOrderTime: new Date(),
                        projectId: '',
                        remark: '',
                        doDetailId: '',
                        deliveryPlanOrderNo: parseInt(info),
                        listDoDetail: [],
                    }
            ...
            showSubData(row, expandedRows) {
                ...
                this.deliveryOrderQuery.returnId = row.returnId;
                this.deliveryOrderQuery.id = row.deliveryOrderId;
            ...
            deliveryOrderList() {
                return deliveryOrderModel.getDeliveryOrderLimit(this.deliveryOrderQuery).then((data) => {
                ...
                deliveryOrderModel.deliveryOrderLoad(row.deliveryOrderId).then((data) => {
                    ...
                    deliveryOrderModel.getDeliveryOrderDetailById(this.deliveryOrderQuery).then((dataD) => {
                        var info = {
                            ...
                            deliveryPlanOrderNo: data.entity.returnId,
