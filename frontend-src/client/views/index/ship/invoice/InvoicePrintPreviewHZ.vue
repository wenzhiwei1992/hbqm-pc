...
<script>
    ...
    export default {
        name: "InvoicePrintPreviewHZ",
        props:['invoicesPrintInfo','invoiceIdHZ'],
        data(){
            return{
                model:{
                    invoiceId:'',
        ...
        methods:{
            list(){
                this.model.invoiceId = this.invoiceIdHZ.id
                planModel.findProductDetailPrintSJ(this.model).then((data)=>{
                    this.invoicesPrintInfoHZ = data.entity.list
            ...
            invoicePrint(){
                ...
                this.$router.push({
                    ...
                    params: {
                        obj:{
                          invoiceIdHZ: this.invoiceIdHZ,
                          invoiceDetailIds:arr,
                          data:this.invoicesPrintInfoHZ,
                          invoicesPrintInfoHZ:this.invoicesPrintInfoHZ
                        }
                        
                    }
                })
                this.$emit('invoice-print-preview-hz-cancel')
            },
            clickRow(){
