...
<div>
    ...
    <!-- <div id="printHtmlView" v-loading="loading">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed">
            <tbody>
                <tr>
                    <td colspan="11" style="height:40px;font-size:16px;">杭州宝业建筑工业化制造有限公司发货单</td>
                </tr>
                <tr>
                    <td colspan="1">
                      发货单号
                ...
                <tr>
                    <td colspan="11">第一联白色 存根联 ；第二联绿色 记账联 ；第三联红色 结算联 ；第四联蓝色 运输联 ；第五联黄色 客户联；</td>
                </tr>
            </tbody>
        </table>
    </div> -->
...
export default {
    ...
    //     console.log("productWtsNum"+this.invoiceData.productWtsNum)
    // },
    activated() {
        this.init()
    },
    methods:{
        ...
        showData(obj){
            return new Promise((resolve,reject)=>{
              this.invoiceData = obj.invoiceIdHZ
