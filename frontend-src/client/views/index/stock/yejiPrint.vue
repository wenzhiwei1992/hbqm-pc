                  ...
                  <tbody>
                      <tr>
                          <td colspan="12" height="50px" style="font-size:25px;" class="center relative">
                              ...
                              <!-- <div class="absolute t-0 flex" style="left:0px;">
                                  ...
                                  <div style="width:50px;height:49px;">
                                      <img src="~@/assets/img/gudemei.jpg" alt="">
                                  </div>
                              </div> -->
                          </td>
                      </tr>
                      <tr>
                          <td class="relative" colspan="6" rowspan="3">
                              <div class="absolute t-0" style="left:20px;">客户及地址</div>
                          ...
                          <td colspan="6">
                              <div class="flex">
                                  ...
                                  <!-- <div class="flex" style="flex:0.4;">
                                      <span>车型：</span>
                                      <div class="div-input"  style="flex:1;" contenteditable="true"></div>
                                  </div> -->
                              </div>
                      ...
                      <tr>
                          <td colspan="6" contenteditable="true">垫木，货架等装车辅助物工地要及时带回,如不带回将按原价计费。</td>
                      </tr>
                      <tr>
                      ...
                      <tr class="right-bottom">
                          <td colspan="2" >
                              <div >装车方量</div>
                              <div contenteditable="true">{{invoiceData.productVol}}m³</div>
                          </td>
                          <td colspan="2" >
                              <div >卸货结束时间</div>
                              <div class="contenteditable" contenteditable="true"></div>
    ...
    methods:{
        ...
        showData(arr){
            ...
            return model.findByInvoiceIdForZSPrint(id).then(data=>{
                ...
                this.invoiceData.productVol = this.ToFixed(data.entity.productVol,3)
